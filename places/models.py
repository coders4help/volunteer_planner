...
class BreadcrumpablePlaceManager(models.Manager):
    def get_queryset(self):
        return (
            super(BreadcrumpablePlaceManager, self)
            .get_queryset()
...
class BreadcrumpablePlaceModel(models.Model):
    ...
    def get_detail_view_name(self):
        ...
        return detail_view_name or "{}-details".format(self._meta.model_name.lower())

    def get_absolute_url(self):
        return reverse(
            self.get_detail_view_name(), args=[o.slug for o in self.breadcrumps]
        )
...
class Region(BreadcrumpablePlaceModel):
    ...
    country = models.ForeignKey(
        Country, models.PROTECT, related_name="regions", verbose_name=_("country")
    )
...
class Area(BreadcrumpablePlaceModel):
    ...
    region = models.ForeignKey(
        Region, models.PROTECT, related_name="areas", verbose_name=_("region")
    )
...
class Place(BreadcrumpablePlaceModel):
    ...
    area = models.ForeignKey(
        Area, models.PROTECT, related_name="places", verbose_name=_("area")
    )
