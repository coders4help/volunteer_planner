    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(max_length=5, verbose_name='postal code', blank=True)),
        ...
        migrations.AddField(
            ...
            name='members',
            field=models.ManyToManyField(to='accounts.UserAccount', through='organizations.OrganizationMembership'),
        ),
        migrations.AddField(
            model_name='facility',
            name='members',
            field=models.ManyToManyField(to='accounts.UserAccount', through='organizations.FacilityMembership'),
        ),
        migrations.AddField(
            model_name='facility',
            name='organization',
